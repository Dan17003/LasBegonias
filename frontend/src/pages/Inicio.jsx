...
export default function Inicio() {
  const cardsResumen = [
    { id: 1, label: "Citas hoy", count: 12, bg: "bg-cyan-50/60 border-cyan-100", textColor: "text-cyan-700", icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
      </svg>
    )},
    { id: 2, label: "Pacientes registrados", count: 253, bg: "bg-teal-50/60 border-teal-100", textColor: "text-teal-700", icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
    )},
    { id: 3, label: "Nuevos pacientes", count: 8, bg: "bg-sky-50/60 border-sky-100", textColor: "text-sky-700", icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
      </svg>
    )},
    { id: 4, label: "Tareas pendientes", count: 5, bg: "bg-slate-50 border-slate-200/60", textColor: "text-slate-700", icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
  ...
  return (
    <div className="p-8 w-full max-w-[1400px] mx-auto font-sans text-slate-700">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-slate-800">¡Bienvenida, Recepcionista!</h2>
        <p className="text-xs text-slate-400 mt-1">Este es el resumen general de la clínica.</p>
      </div>
